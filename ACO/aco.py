...
class ACO:
        ...
        for v in range(so_vong):
            ...
            for k in range(self.m):
                ...
                if v == 0 and k < 5:
                    ...
                    print(f"\n Đường đi của kiến {k + 1} trong vòng đầu:")
                    print(" -> ".join([f"TP{t + 1}" for t in tour]))
                    print(f"Độ dài: {do_dai:.2f}\n")
    ...
    def ve_bieu_do(self, toa_do, best_tour):
        ...
        axes[1].set_title("5 đường đi của kiến trong vòng đầu")
        colors = ['blue', 'green', 'orange', 'purple', 'brown']
        for i, tour in enumerate(self.lich_su_kien[:5]):
